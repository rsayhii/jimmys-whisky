...
<!-- SERVICES SECTION -->
<section class="py-6 md:py-10 bg-[#FAF7F2]">
  <div class="max-w-7xl mx-auto px-4">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-8">
      ...
      <div class="flex items-center group">
        <div
          class="w-10 h-10 md:w-14 md:h-14 border border-dashed border-black rounded-full flex items-center justify-center transition-all duration-300 group-hover:shadow-[inset_0_0_0_40px_rgba(255,255,255,0.55)]">
          
          <!-- SVG 1 -->
          <svg class="w-5 h-5 md:w-8 md:h-8 text-black" viewBox="0 0 50 50" fill="currentColor">
        ...
        <div class="ml-2 md:ml-4">
          <h5 class="text-[10px] md:text-sm font-semibold text-gray-800">Up To 50% Offer</h5>
          <p class="text-[10px] md:text-sm text-gray-600">On all your Perfume orders</p>
        </div>
      </div>
      ...
      <div class="flex items-center group">
        ...
        <div class="ml-2 md:ml-4">
          <h5 class="text-[10px] md:text-sm font-semibold text-gray-800">Perfume Variety</h5>
          <p class="text-[10px] md:text-sm text-gray-600">Explore Scents for Everyone</p>
        </div>
      </div>
      ...
      <div class="flex items-center group">
        ...
        <div class="ml-2 md:ml-4">
          <h5 class="text-[10px] md:text-sm font-semibold text-gray-800">Free Shipping</h5>
          <p class="text-[10px] md:text-sm text-gray-600">On orders from ₹799</p>
        </div>
      </div>
      ...
      <div class="flex items-center group">
        <div
          ...
          <!-- SVG 4 -->
          <svg class="w-5 h-5 md:w-7 md:h-7 text-black" viewBox="0 0 16 16" fill="currentColor">
        ...
        <div class="ml-2 md:ml-4">
          <h5 class="text-[10px] md:text-sm font-semibold text-gray-800">Genuine Products</h5>
          <p class="text-[10px] md:text-sm text-gray-600">100% authentic products</p>
        </div>
      </div>
