{{-- Hero Section --}}
<div id="hero" class="hero-section relative w-full h-[550px] overflow-hidden">
    {{-- Slides --}}
    ...
    {{-- Navigation --}}
    <button id="hero-prev" class="absolute left-4 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white rounded-full py-3 px-5 hover:bg-opacity-70 z-20">❮</button>
    <button id="hero-next" class="absolute right-4 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white rounded-full py-3 px-5 hover:bg-opacity-70 z-20">❯</button>
</div>
