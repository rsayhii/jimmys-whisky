            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input id="name" name="name" type="text" autocomplete="name" required class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-[#c0863d] focus:border-[#c0863d] sm:text-sm transition-all" placeholder="John Doe">
                    </div>
                </div>
