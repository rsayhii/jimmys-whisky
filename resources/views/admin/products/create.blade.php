                    ...
                    <div class="bg-white p-8 rounded-3xl shadow-[0_2px_20px_rgba(0,0,0,0.04)] border border-gray-100 hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-shadow duration-300">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Ocean Breeze Pour Homme" class="w-full border border-gray-200 rounded-xl p-3.5 outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all bg-gray-50/50 focus:bg-white placeholder-gray-400" required>
                                @error('name') <span class="text-xs text-red-500">{{ $message }}</span> @enderror
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Brand</label>
                                    <input type="text" name="brand" value="{{ old('brand') }}" placeholder="e.g. Chanel, Dior" class="w-full border border-gray-200 rounded-xl p-3.5 outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all bg-gray-50/50 focus:bg-white placeholder-gray-400">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">SKU</label>
                                    <input type="text" name="sku" value="{{ old('sku') }}" placeholder="e.g. PRF-001" class="w-full border border-gray-200 rounded-xl p-3.5 outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all bg-gray-50/50 focus:bg-white placeholder-gray-400">
                                </div>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Short Description</label>
                                <textarea name="short_description" rows="3" class="w-full border border-gray-200 rounded-xl p-3.5 outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all bg-white placeholder-gray-400" placeholder="Brief summary of the product...">{{ old('short_description') }}</textarea>
                            </div>
                            <div>
                                ...
                                <div class="border border-gray-200 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-black/5 focus-within:border-black transition-all bg-white">
                                    <textarea id="editor" name="description" rows="5" class="w-full p-4 outline-none resize-none text-gray-600 bg-transparent" placeholder="Describe the scent profile, inspiration, and key characteristics...">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-4 p-1.5 bg-gray-100 rounded-xl w-fit">
                                        ...
                                        <label class="cursor-pointer">
                                            <input type="radio" name="gender" value="{{ $g }}" class="peer sr-only" {{ old('gender', 'Unisex') == $g ? 'checked' : '' }}>
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="price" value="{{ old('price') }}" placeholder="0.00" class="w-full border border-gray-200 rounded-xl p-3.5 pl-8 outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all" required>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 font-serif">₹</span>
                                    <input type="number" name="discount_price" value="{{ old('discount_price') }}" placeholder="0.00" class="w-full border border-gray-200 rounded-xl p-3.5 pl-8 outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all">
                                </div>
                            </div>
                            <div class="flex items-center gap-3 py-2 px-3 bg-gray-50 rounded-xl">
                                <input type="hidden" name="taxable" value="0">
                                <input type="checkbox" name="taxable" value="1" {{ old('taxable', 1) ? 'checked' : '' }} class="w-5 h-5 text-black rounded border-gray-300 focus:ring-black accent-black">
                    ...
                    <div class="bg-white p-6 rounded-3xl shadow-[0_2px_20px_rgba(0,0,0,0.04)] border border-gray-100 hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-shadow duration-300">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <div class="relative">
                                    <select name="status" class="w-full border border-gray-200 rounded-xl p-3.5 outline-none focus:ring-2 focus:ring-black/5 focus:border-black appearance-none bg-white cursor-pointer">
                                        @foreach(['Published', 'Draft', 'Scheduled', 'Inactive'] as $s)
                                ...
                                <div class="relative">
                                    <select name="collection" class="w-full border border-gray-200 rounded-xl p-3.5 outline-none focus:ring-2 focus:ring-black/5 focus:border-black appearance-none bg-white cursor-pointer">
                                        ...
                                        @foreach([
                                            ...
                                            <option value="{{ $col }}" {{ old('collection') == $col ? 'selected' : '' }}>{{ $col }}</option>
                                        @endforeach
                                    </select>
                                    <div class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
                                        <i class="fas fa-chevron-down text-xs"></i>
                            ...
                            <div>
                                ...
                                <input type="text" name="tags" value="{{ old('tags') }}" placeholder="e.g. #floral, #summer, #gift" class="w-full border border-gray-200 rounded-xl p-3.5 outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all">
                             ...
                             <div>
                                ...
                                <input type="number" name="qty" value="{{ old('qty') }}" placeholder="Qty" class="w-full border border-gray-200 rounded-xl p-3.5 outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all">
                            </div>
                        </div>
                    </div>
                </div>
