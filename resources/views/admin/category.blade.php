...
<script>
    ...
    function openEditModal(category) {
        ...
        // Set Form Action
        document.getElementById('editForm').action = "{{ route('admin.categories.index') }}/" + category.id;
    ...
    function openViewModal(category) {
        ...
        statusSpan.innerText = category.status.charAt(0).toUpperCase() + category.status.slice(1);
